...
import sawtoothshirts from '../images/projects/sawtoothshirts.png'
import freshbeards from '../images/projects/freshbeards.png'
import compete from '../images/projects/compete.png'
import l2l from '../images/projects/l2l.png'
import techbret from '../images/projects/techbret.svg'
import space from '../images/projects/space.png'
import gutter from '../images/projects/gutter.png'
import noon from '../images/projects/noon.png'
import rfc from '../images/projects/rfc.png'
import logo from '../images/projects/logo.png'
import brighter from '../images/projects/brighter.svg'
import reading from '../images/projects/reading.svg'
...
function Review({ title, body, author, rating, image, className, ...props }) {
  ...
  return (
    <figure
      className={clsx(
       ` animate-fade-in rounded-3xl ${title === "gutter" ? "bg-gray-900" : "bg-white"} p-6 opacity-0 shadow-md shadow-gray-900/5`,
        className,
      )}
    ...
    >
       ...
       <img src={image} alt="military logos" className="h-auto w-auto" unoptimized />
    ...
    >
      <Container>
        ...
        <p className="mt-2 text-lg text-gray-600 sm:text-center">
          We&apos;ve worked on a lot of projects over the years. Here are a few of our favorites.
        </p>
        <ReviewGrid />
      </Container>
    </section>
